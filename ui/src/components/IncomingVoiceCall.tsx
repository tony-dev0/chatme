...
const IncomingVoiceCall = ({ caller, answerCall, endCall }: any) => {
  const profilePic = new URL(caller?.profilePic, import.meta.url).href;
  return (
...
export default React.memo(IncomingVoiceCall);
